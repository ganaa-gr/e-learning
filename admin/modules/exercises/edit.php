...
?> 
 ...
 <form class="form-horizontal span6" action="controller.php?action=edit" method="POST" style="margin-top: 20px;"> 
                        <div class="row">
                           <div class="col-lg-12">
                              <h1 class="page-header">Асуултаа засварлах</h1>
                            </div>
                            <!-- /.col-lg-12 -->
                         </div>
                       ...
                       <div class="form-group">
                        <div class="col-md-8">
                          <label class="col-md-4 control-label" for=
                          "Question">Асуулт:</label>

                          <div class="col-md-8">
                            <textarea  class="form-control input-sm" id="Question" name="Question" placeholder=
                                "Асуултын нэр" type="text"><?php echo $res->Question;?></textarea>
