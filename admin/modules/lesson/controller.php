...
switch ($action) {
	...
	function doInsert(){ 
		if(isset($_POST['save'])){ 
			...
			message("Хичээлийг мэдээллийн санд хадгалав.", "success");
			redirect("index.php");
	...
	function dochangefile(){
		if(isset($_POST['save'])){   
			$id = $_POST['LessonID']; 
				...
				message("Файлыг мэдээллийн санд шинэчилсэн.", "success");
				redirect("index.php");
			...
			if($imageFileType != "jpg" || $imageFileType != "png" || $imageFileType != "jpeg"
				|| $imageFileType != "gif" || $imageFileType != "docs" || $imageFileType != "mp4") {
				 if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
					...
					echo "Файл байршуулахад алдаа гарав";
					exit;
				}
			}else{
					echo "Файлыг дэмжээгүй";
					exit;
	 }
} 
